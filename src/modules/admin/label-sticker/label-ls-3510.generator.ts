...
import { LS3510LabelStickerDto } from './dto/label-sticker-request.dto';
import { Injectable } from '@nestjs/common';

// === 라벨/용지 레이아웃 상수 ===
const A4_WIDTH = 210; // mm
const A4_HEIGHT = 297; // mm
const PADDING_TOP = 14.5; // mm
const PADDING_BOTTOM = 16.5; // mm
const PADDING_SIDE = 9.9; // mm
const CENTER_GAP = 8; // mm
const LABEL_COLS = 2;
const LABEL_ROWS = 5;
...
@Injectable()
export class LabelStickerPdfGeneratorLS3510 {
  ...
  async generatePDF(data: LS3510LabelStickerDto[] = []): Promise<Buffer> {
    const options = {
      format: 'A4',
